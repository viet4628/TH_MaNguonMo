...
<div class="main-container">
    ...
    <form id="productForm" class="product-form" method="POST" action="/Product/save" enctype="multipart/form-data" onsubmit="return validateForm();">
            ...
            <div class="right-section">
                ...
                <div class="image-upload-container" id="dropZone">
                    ...
                    <div class="current-image" id="imagePreview">
                        <!-- Ảnh preview sẽ được hiển thị ở đây -->
                    </div>
                </div>
            </div>
        </div>
